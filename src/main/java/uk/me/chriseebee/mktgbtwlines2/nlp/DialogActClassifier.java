...
public class DialogActClassifier {
  ...
  private static String where = "/Users/cbell/dialog/";
  ...
  public static void main(String[] args) throws Exception {
    ...
    ColumnDataClassifier cdc = new ColumnDataClassifier(where + "dialog.prop");
    cdc.trainClassifier(where + "dialog-data.train");

    System.out.println();
    System.out.println("Testing predictions of ColumnDataClassifier");
    for (String line : ObjectBank.getLineIterator(where + "dialog-data.test", "utf-8")) {
    ...
    Pair<Double, Double> performance = cdc.testClassifier(where + "dialog-data.test");
  ...
  private static void demonstrateSerialization()
    ...
    Classifier<String,String> cl =
            cdc.makeClassifier(cdc.readTrainingExamples(where + "dialog-data.train"));
    ...
    //FileOutputStream fos = new FileOutputStream(where + "dialog.classifier");
    //fos.write(object);
    ...
    ois.close();
    ColumnDataClassifier cdc2 = new ColumnDataClassifier(where + "dialog.prop");
